...
public class Test2 {
    public static void main(String[] args) {
        ...
        System.out.println("Modelo del vehículo: " + vehicle.getModel()); // Error: The field model is not visible

        System.out.println("Marca del motocicleta: " + motorcycle.brand); // Error: The field brand is not visible
        System.out.println("Modelo del motocicleta: " + motorcycle.getModel()); // Error: The field model is not visible
        System.out.println("Cilindraje: " + motorcycle.isCilindrical); // Podemos acceder ya que es publico
    }
}
